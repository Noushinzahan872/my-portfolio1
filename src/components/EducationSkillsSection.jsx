...
const educationData = [
  {
    title: "Master of Science in Computer Science and Engineering (M.Sc.in C.S.E)",
    institution: "Jagannath University",
    session: "Ongoing",
    description: "Pursuing advanced studies with a focus on research and software engineering.",
    course: "",
    icon: <FaGraduationCap className="text-white text-3xl" />,
  },
  {
    title: "Bachelor of Science in Computer Science (C.S.E)",
    institution: "Institute of Science & Technology (I.S.T)",
    session: "2018-2019",
    description: "Graduated with honors, focusing on full-stack development.",
    course: "Certification with Programming Hero",
    icon: <FaGraduationCap className="text-white text-3xl" />,
  },
];
...
//     session: "2018-2019",
//     description: "Graduated with honors, focusing on full-stack development.",
//     course:"Cetification with Programming Hero",
//     icon: <FaGraduationCap className="text-white text-3xl" />,
//   },
// ];
